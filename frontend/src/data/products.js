...
export const initialProducts = [
  { id: 'p1', name: 'سكر 1 كغ', category: 'food', price: 2.5, purchasePrice: 2.05, unit: 'كغ', stock: 42, minStock: 10, step: 1 },
  { id: 'p2', name: 'قهوة 250 غ', category: 'food', price: 4.8, purchasePrice: 3.9, unit: 'قطعة', stock: 18, minStock: 8, step: 1 },
  { id: 'p3', name: 'حليب 1 لتر', category: 'food', price: 1.5, purchasePrice: 1.2, unit: 'لتر', stock: 6, minStock: 12, step: 1 },
  { id: 'p4', name: 'زيت نباتي 1 لتر', category: 'food', price: 4.2, purchasePrice: 3.6, unit: 'لتر', stock: 25, minStock: 10, step: 1 },
  { id: 'p5', name: 'أرز 1 كغ', category: 'food', price: 3.9, purchasePrice: 3.2, unit: 'كغ', stock: 30, minStock: 10, step: 0.5 },
  { id: 'p6', name: 'ماء معدني 1.5 لتر', category: 'drinks', price: 0.8, purchasePrice: 0.55, unit: 'قطعة', stock: 96, minStock: 24, step: 1 },
  { id: 'p7', name: 'فلفل أحمر 100 غ', category: 'spices', price: 1.2, purchasePrice: 0.9, unit: 'غ', stock: 15, minStock: 5, step: 1 },
  { id: 'p8', name: 'طماطم معلبة', category: 'canned', price: 2.3, purchasePrice: 1.8, unit: 'قطعة', stock: 40, minStock: 12, step: 1 },
  { id: 'p9', name: 'كسكسي 1 كغ', category: 'food', price: 2.9, purchasePrice: 2.3, unit: 'كغ', stock: 22, minStock: 8, step: 0.5 },
  ...
  { id: 'p12', name: 'عصير برتقال 1 لتر', category: 'drinks', price: 2.4, purchasePrice: 1.9, unit: 'لتر', stock: 20, minStock: 8, step: 1 },
  { id: 'p13', name: 'مشروب غازي 1.5 لتر', category: 'drinks', price: 2.6, purchasePrice: 2.0, unit: 'قطعة', stock: 3, minStock: 12, step: 1 },
  { id: 'p14', name: 'كمون مطحون 100 غ', category: 'spices', price: 1.8, purchasePrice: 1.3, unit: 'غ', stock: 17, minStock: 5, step: 1 },
